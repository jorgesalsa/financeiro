    ...
    const sheets: { name: string; headers: string[]; example: Record<string, string> }[] = [
      ...
      },
      {
        ...
        example: {
          ...
          competence_date: "2025-01-01",
          due_date: "2025-02-20",
          description: "Venda de servicos - Contrato 789",
          amount: "5000.00",
          financial_nature: "OPERATIONAL",
          chart_of_account_code: "4.1.01",
          cost_center_code: "CC002",
          customer_cnpj_cpf: "98.765.432/0001-10",
          customer_name: "Cliente XYZ S.A.",
          bank_code: "001",
          agency: "1234-5",
          account_number: "12345-6",
          payment_method: "BOLETO",
          document_number: "FAT-789",
          notes: "Ref. contrato 789",
        },
      },
    ];
