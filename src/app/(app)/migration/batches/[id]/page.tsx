...
export default async function BatchDetailPage({
  ...
  try {
    ...
    serializedBatch = {
      ...
      sourceErpName: batch.sourceErpName,
      ...
      expectedTotalAmount: batch.expectedTotalAmount ? Number(batch.expectedTotalAmount) : null,
      actualTotalAmount: batch.calculatedTotalAmount ? Number(batch.calculatedTotalAmount) : null,
    ...
    serializedItems = itemsResult.items.map((item) => ({
      ...
      correctedData: item.correctedData,
