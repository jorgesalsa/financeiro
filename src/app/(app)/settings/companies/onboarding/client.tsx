...
const STEPS = [
  ...
  { label: "Contas Bancarias", icon: Landmark },
  { label: "Configuracao Inicial", icon: Settings },
];
        ...
        {STEPS.map((step, idx) => {
          ...
          return (
            <div key={step.label} className="flex items-center gap-2 flex-1">
              <div
                className={cn(
                  "flex items-center gap-2 rounded-md px-3 py-2 text-xs font-medium transition-colors flex-1",
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <input
                type="text"
                value={tenantCnpj || "Nao informado"}
                readOnly
                className="w-full rounded-md border border-border bg-muted px-3 py-2 text-sm"
              />
            </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <p className="text-sm text-muted-foreground">
              A empresa <strong>{tenantName}</strong> esta pronta para uso.
              {bankAccounts.length > 0 && (
                <>
                  {" "}
                  {bankAccounts.length}{" "}
                  {bankAccounts.length === 1
                    ? "conta bancaria foi criada"
                    : "contas bancarias foram criadas"}
                  .
                </>
              )}
            </p>
